...
CREATE TABLE `asistencias_clase` (
  ...
  KEY `fk_asistencia_persona` (`persona_id`),
  KEY `fk_asistencia_confirmador` (`confirmado_por`),
  CONSTRAINT `fk_asistencia_confirmador` FOREIGN KEY (`confirmado_por`) REFERENCES `personas` (`id`),
  CONSTRAINT `fk_asistencia_persona` FOREIGN KEY (`persona_id`) REFERENCES `personas` (`id`),
  CONSTRAINT `fk_asistencia_sesion` FOREIGN KEY (`sesion_clase_id`) REFERENCES `sesiones_clase` (`id`)
