...
class PersonaDAO:
    ...
    @staticmethod
    def create(nombre, apellido, telefono, email, tipo_persona, carrera, seccion, 
               foto_path, encoding_facial, codigo_carnet, password_hash=None):
        """Create a new person record"""
        query = """
            INSERT INTO personas 
            (nombre, apellido, telefono, email, tipo_persona, carrera, seccion, 
             foto_path, encoding_facial, codigo_carnet, password_hash)
        ...
        params = (nombre, apellido, telefono, email, tipo_persona, carrera, seccion,
                 foto_path, encoding_json, codigo_carnet, password_hash)
    ...
    def get_by_type(tipo_persona):
        ...
        query = "SELECT * FROM personas WHERE tipo_persona = %s ORDER BY apellido, nombre"
    ...
    def get_all():
        """Get all persons"""
        query = "SELECT * FROM personas ORDER BY tipo_persona, apellido, nombre"
